This is an example of a responsive website built with Bootstrap 3 framework. The solutions and design used for this project can be customised and applied for a similar website.
